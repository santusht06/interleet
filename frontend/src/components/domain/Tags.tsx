...
import type { Difficulty, Domain } from "@/lib/mock";
...
export function DifficultyPill({ d, className }: { d: Difficulty; className?: string }) {
  return (
    <Badge
      variant="outline"
      className={cn(
...
export function DomainTag({ d }: { d: Domain }) {
  return (
