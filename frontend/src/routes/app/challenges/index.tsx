...
function ChallengesPage() {
  ...
  const openChallenge = (slug: string) => {
    navigate({ to: "/app/challenges/$id", params: { id: slug } });
  };
      ...
      <div className="px-4 py-6 md:px-8">
        ...
        <div className="flex flex-col gap-3 rounded-xl border border-border bg-card p-3 md:flex-row md:items-center">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <Select value={diff} onValueChange={(v) => setDiff(v as Difficulty | "all")}>
