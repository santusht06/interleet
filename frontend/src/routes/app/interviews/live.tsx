...
export const Route = createFileRoute("/app/interviews/live")({
  head: () => ({ meta: [{ title: "Live AI Interview · Interleet" }] }),
  component: LiveInterview,
});

const TRANSCRIPT: { from: "ai" | "you"; text: string; t: string }[] = [
