...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Interleet — The Complete Engineering Arena" },
      {
        name: "description",
        content:
          "Bridging the gap between DSA and real-world engineering. Practice frontend, backend, DevOps, APIs, databases, and system design. AI mock interviews, leaderboards, recruiter-verified profiles.",
      },
    ],
  }),
  component: Landing,
...
function Domains() {
  const items: { i: typeof Code2; t: string; d: string }[] = [
